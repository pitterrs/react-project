...
import { AppBar, Toolbar, List, ListItem, Drawer, ListItemText, makeStyles, Box, Link, IconButton } from "@material-ui/core";
...
const Logo = ({ linkProps, ...props }) => {
    const classes = useStyles();
    return (
        <Link {...linkProps}>
            <Box className={classes.logoContainer}>
                <svg className={classes.logo} xmlns="http://www.w3.org/2000/svg" width="192" height="36" viewBox="0 0 192 36">
                    <g fill="none">
...
const SideDrawer = ({ navLinks }) => {
    ...
    return (
        <React.Fragment>
            ...
            >
                <MenuIcon fontSize="large" color="#666" />
            </IconButton>
    ...
    return (
        <AppBar className={classes.header}>
            <Toolbar className={classes.toolbar}>
                <Logo linkProps={{ href: "/hi" }} />
            </Toolbar>
            <Box>
                <List component="nav" className={classes.navItems} aria-labelledby="main navigation">
                    {navLinks.map(({ title, path }) => (
